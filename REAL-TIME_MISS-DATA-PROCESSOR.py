...
3. Launches multiple subprocesses (keogram maker, RGB column maker, average PNG maker, kho_website_feed, and spectrogram processor).
...
# Centralise all paths in a dictionary
config = {
    ...
    try:
        while running:
            ...
            if current_time - last_execution_time >= 60:
                ...
                # Start new processes
                processes.append(start_subprocess("TEST_KEO_ANALYTICS.PY", config))
